...
import eslintCLIEngine from "eslint/lib/cli-engine/cli-engine";
import eslintFileEnumerator from "eslint/lib/cli-engine/file-enumerator";

const { CLIEngine } = eslintCLIEngine;
const { FileEnumerator, CascadingConfigArrayFactory } = eslintFileEnumerator;

import { formatResults } from "./formatter.mjs";
